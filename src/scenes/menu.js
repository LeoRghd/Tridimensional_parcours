var createMenuScene = function (scene, camera) {
    const core = 'menu'
    ...
    playButton.onPointerUpObservable.add(function () {
        // Cacher le GUI et commencer le jeu
        advancedTexture.dispose()
        background.dispose()
        // backgroundCamera.dispose()
        backgroundCamera.detachControl(canvas);
        scene.activeCamera = camera // Remplacez "votreCaméraPrincipale" par la caméra que vous utilisez pour le reste de la scène
